                            ...
                            <div className="relative flex items-center">
                                <span className={cn(
                                    'flex h-10 w-10 items-center justify-center rounded-full font-bold z-10',
                                    {
                                        ...
                                        'border-2 border-primary-foreground bg-primary-foreground text-primary': status === 'current',
                                        'border-2 border-primary-foreground/50 text-primary-foreground/50': status === 'upcoming',
                                    }
                                )}>
                                    {status === 'complete' ? (
    ...
    return (
        <>
            ...
            <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="e.g. Employer@gmail.com" required />
            </div>
            <div className="space-y-2">
                <Label htmlFor="position">Position*</Label>
                <Input id="position" placeholder="e.g. Sales Manager" required />
            </div>
            <div className="space-y-2">
    ...
    return (
        <>
            <div className="space-y-2">
                ...
                <Input id="company-name" placeholder="e.g. Bepall" required />
            </div>
             <div className="space-y-2">
                 ...
                 <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleNextStep} className="space-y-8">
                        ...
                        <div className="flex justify-end gap-4">
                             {step > 1 && (
                                <Button type="button" variant="outline" onClick={handlePreviousStep} className="h-12 text-base px-8">
                                    Back
                                </Button>
                             )}
